...
```
*Requires authentication, access depends on subscription*
...
│   └── views.py           # API views
├── subscription/            # Subscription management app
│   ├── __init__.py
│   ├── admin.py           # Admin configuration
│   ├── migrations/        # Database migrations
│   ├── models.py          # Subscription and tariff models
│   ├── serializers.py     # API serializers
│   ├── urls.py            # App URL patterns
│   └── views.py           # API views
...
- **Payment Integration**: Stripe/PayPal integration for subscription payments
- **Lecture System**: Individual lecture management within courses
- **Progress Tracking**: User progress and completion tracking
- **Content Search**: Full-text search across courses and categories
- **Analytics Dashboard**: Usage statistics and business metrics
